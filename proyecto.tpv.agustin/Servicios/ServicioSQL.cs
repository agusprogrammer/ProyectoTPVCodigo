...
namespace proyecto.tpv.agustin.Servicios
{
    public class ServicioSQL
    {
        ...
        /// </summary>
        /// <param name="providerName">Nos indica el proveedor de la base de
        /// datos</param>
        /// <returns></returns>
        ...
        /// </summary>
        /// <param name="query"> Consulta necesaria para obtener los
        ///datos</param>
        /// <returns></returns>
        public DataTable getDatos(string query)
        {
            ...
            // Obtenemos los datos en función de la conexión y de la
            // sentencia SELECT
